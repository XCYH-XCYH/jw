...
const router = new Router({
    ...
    routes: [
        {   
            ...
            children:[
                { path: 'userManagement' , name: 'UserManagement', component: () => import('@/views/main/UserManagement.vue') },
                ...
                { path: 'ruleManagement' , name: 'RuleManagement', component: () => import('@/views/main/RuleManagement.vue') }
            ]
        }
